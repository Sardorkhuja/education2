...
const source=await readFile(path.join(root,'src/Education.html'),'utf8');
...
await writeFile(path.join(output,'manifest.webmanifest'),JSON.stringify({id:'/',name:'Education',short_name:'Education',description:'Classes, deadlines and grades. One thoughtful space for university life.',lang:'en',start_url:'/',scope:'/',display:'standalone',background_color:'#f5f5f7',theme_color:'#f5f5f7',icons:[{src:'./icons/icon-192.png',sizes:'192x192',type:'image/png',purpose:'any maskable'},{src:'./icons/icon-512.png',sizes:'512x512',type:'image/png',purpose:'any maskable'}]},null,2)+'\n');
